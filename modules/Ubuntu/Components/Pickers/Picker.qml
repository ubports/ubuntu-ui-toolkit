...
StyledItem {
    ...
    Loader {
        ...
        Connections {
            ...
            // focus handling
            onMoveStarted: picker.gainFocus(Qt.MouseFocusReason)
            onFlickStarted: picker.gainFocus(Qt.MouseFocusReason)
        }
    ...
    Component {
        ...
        PathView {
            ...
            clip: true
            focus: true
            Mouse.onClicked: picker.gainFocus()
    ...
    Component {
        ...
        ListView {
            ...
            clip: true
            focus: true
            Mouse.onClicked: picker.gainFocus(Qt.MouseFocusReason)
