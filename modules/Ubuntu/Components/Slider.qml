    ...
    */
    ...
    MouseArea {
        ...
        */
        ...
        onClicked: if (slider.activeFocusOnMousePress) slider.forceActiveFocus(Qt.MouseFocusReason)
        onLiveValueChanged: if (isPressed && slider.activeFocusOnMousePress) slider.forceActiveFocus(Qt.MouseFocusReason)
    }
