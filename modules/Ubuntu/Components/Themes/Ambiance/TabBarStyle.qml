...
Item {
    ...
    property color headerTextColor: styleSet.palette.normal.backgroundText
    property color headerTextSelectedColor: styleSet.palette.selected.backgroundText
    ...
    property color headerTextStyleColor: styleSet.palette.normal.backgroundText
