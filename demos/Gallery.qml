...
Rectangle {
    ...
    ListView {
        ...
        property int selectedIndex: 13+2 // TODO TIM: make 0 after finish testing
        model: [{"label": i18n.tr("Theming"), "source": "Theming.qml"},
                ...
                {"label": i18n.tr("Popovers"), "source": "Popovers.qml"},
                {"label": i18n.tr("Toolbars"), "source": ""},
                {"label": i18n.tr("Sheets & Dialogues"), "source": "Sheets.qml"},
