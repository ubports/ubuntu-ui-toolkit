...
test_performance.commands = cd $$OUT_PWD/tests/unit/tst_performance; make check
test_performance.depends = sub-modules-ubuntu-ui-toolkit-pro
QMAKE_EXTRA_TARGETS += test_performance

test_api.target = test-api
test_api.commands = cd $$OUT_PWD/tests/unit/tst_components; make check
...
qmluitests.commands = cd $$OUT_PWD/tests/unit_x11; make check
