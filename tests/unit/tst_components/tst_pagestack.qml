...
TestCase {
    ...
    function test_tabs_inside_stack_bug1187850() {
        ...
        compare(mainView.__propagated.header.contents, tabs.__headerContents, "Pushing Tabs on PageStack updates the header contents");
        pageStack.push(page1);
        ...
        compare(mainView.__propagated.header.contents, tabs.__headerContents, "Active Tabs controls header contents");
        pageStack.clear();
    }
