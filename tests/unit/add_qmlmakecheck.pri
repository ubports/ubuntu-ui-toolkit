...
check.commands += BUILTINS=QQuick,QQml,U1db:: python tests/qmlapicheck.py modules/Ubuntu/Components/qmldir modules/Ubuntu/Components/*/qmldir plugins.qmltypes > components.api.new;
