    ...
    Header {
        ...
        Rectangle {
            ...
            Label {
                ...
                text: "Header outside ListView"
                color: "white"
            }
        }
        onExposedChanged: print("exposed one = "+exposed)
//        flickable: listView
        exposed: false
        z: 2
    }
    ...
    ListView {
        ...
        delegate: ListItem {
            ...
            onClicked: listView.headerItem.exposed = !listView.headerItem.exposed
        }
        ...
        header: Component {
            Header {
                ...
                Rectangle {
                    ...
                    Label {
                        anchors.centerIn: parent
                        text: "Header inside ListView"
                        color: "white"
                    }
                }
                onYChanged: print("in-header.y = "+y)
