...
private Q_SLOTS:
    ...
    void testCase_SimpleLayout_Medium()
    {
        ...
        root->setWidth(UCUnits::instance().gu2(55));
        QCOMPARE(root->width(), UCUnits::instance().gu2(55));
    ...
    void testCase_SimpleLayout_Large()
    {
        ...
        root->setWidth(UCUnits::instance().gu2(65));
        QCOMPARE(root->width(), UCUnits::instance().gu2(65));
        layoutChangeSpy.wait(100);
        QCOMPARE(layoutChangeSpy.count(), 1);
    ...
    void testCase_NestedLayouts_ExtraLarge()
    {
        ...
        root->setWidth(UCUnits::instance().gu2(90));
        layoutChangeSpy.wait(100);
        QCOMPARE(layoutChangeSpy.count(), 1);

        QCOMPARE(layouts->currentLayout(), QString("extra-large"));

        root->setWidth(UCUnits::instance().gu2(50));
        layoutChangeSpy.wait(100);
    ...
    void testCase_ResizingContainers()
    {
        ...
        layoutChangeSpy.wait(100);
        QCOMPARE(layouts->currentLayout(), QString("small"));
        QCOMPARE(item->width(), UCUnits::instance().gu2(10));
        QCOMPARE(item->height(), UCUnits::instance().gu2(10));

        root->setWidth(UCUnits::instance().gu2(60));
        layoutChangeSpy.wait(100);
        QCOMPARE(layouts->currentLayout(), QString("large"));
        QCOMPARE(item->width(), UCUnits::instance().gu2(22));
        QCOMPARE(item->height(), UCUnits::instance().gu2(22));

        root->setWidth(UCUnits::instance().gu2(80));
        layoutChangeSpy.wait(100);
        QCOMPARE(layouts->currentLayout(), QString("xlarge"));
        QCOMPARE(item->width(), UCUnits::instance().gu2(30));
        QCOMPARE(item->height(), UCUnits::instance().gu2(30));
        QCOMPARE(item2->width(), UCUnits::instance().gu2(40));
        QCOMPARE(item2->height(), UCUnits::instance().gu2(50));

        root->setWidth(UCUnits::instance().gu2(40));
        layoutChangeSpy.wait(100);
